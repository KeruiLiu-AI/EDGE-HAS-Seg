...
# from Ferry import CrossModalMultiDirectionalAttentionModule, DynamicFeatureFusionMechanism
from model.EDGE import ResUNet_EDGE_Encoder
from model.TAMW import ResUNet_TAMW_Decoder

class HASSeg(nn.Module):
    ...
    def __init__(self, 
        ...
        self.encoder = ResUNet_EDGE_Encoder(self.in_channels, self.num_channels, self.window_size, 
